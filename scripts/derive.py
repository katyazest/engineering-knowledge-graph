"""Run Engineering KG graph derivation through the reusable pipeline."""
...
def main() -> int:
    parser = ArgumentParser(description="Run Engineering KG graph derivation via the MVP pipeline.")
    parser.add_argument(
        "registry_path",
        help="Local repo-index.yaml workspace registry path with graph-derivation configured.",
    )
    parser.add_argument(
        "--persistence-path",
