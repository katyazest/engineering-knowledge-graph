...
The `workspace-openlore-source` capability defines validation for workspace-level OpenLore source configuration and federation references without duplicating OpenLore code intelligence in Engineering KG.
