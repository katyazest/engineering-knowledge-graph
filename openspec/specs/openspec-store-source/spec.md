...
The `openspec-store-source` capability defines validation of the OpenSpec store source used for durable specifications, intended changes, wiki content, and versioned Engineering KG configuration.
